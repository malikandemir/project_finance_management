...
class MyResponsibleTasksWidget extends BaseWidget
{
    ...
    {
        return __('filament::widgets.my_responsible_tasks.heading');
    }
    
    public function table(Table $table): Table
    {
        return $table
            ->heading(__('filament::widgets.my_responsible_tasks.table_heading'))
            ->query(
                Task::query()
